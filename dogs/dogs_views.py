...
def search(request):
	...
	if 'personalidade' in request.GET:
	...
	elif 'breed' not in request.GET or 'size' not in request.GET or 'color' not in request.GET or request.GET['breed'] == '' or request.GET['size'] == '' or request.GET['color'] == '':
		r = Breed.objects.all()
		rn = len(r)
