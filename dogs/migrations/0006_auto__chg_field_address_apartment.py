...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.apartment'
        db.alter_column(u'dogs_address', 'apartment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Address.apartment'
        db.alter_column(u'dogs_address', 'apartment', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
