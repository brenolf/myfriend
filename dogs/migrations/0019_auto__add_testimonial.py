...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dogs_testimonial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('related_dog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dog', to=orm['dogs.Dog'])),
            ('adopter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='adopter', null=True, to=orm['dogs.Person'])),
            ('giver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='giver', null=True, to=orm['dogs.Person'])),
        ...
        db.send_create_signal(u'dogs', ['Testimonial'])


    def backwards(self, orm):
        # Deleting model 'Testimonial'
        db.delete_table(u'dogs_testimonial')
    ...
    models = {
        ...
        u'dogs.testimonial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'related_dog': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dog'", 'to': u"orm['dogs.Dog']"}),
