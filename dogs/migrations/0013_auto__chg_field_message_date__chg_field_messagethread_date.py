...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dogs_message', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'MessageThread.date'
        db.alter_column(u'dogs_messagethread', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Message.date'
        db.alter_column(u'dogs_message', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'MessageThread.date'
        db.alter_column(u'dogs_messagethread', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
