...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageThread.closed'
        db.add_column(u'dogs_messagethread', 'closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MessageThread.closed'
        db.delete_column(u'dogs_messagethread', 'closed')
