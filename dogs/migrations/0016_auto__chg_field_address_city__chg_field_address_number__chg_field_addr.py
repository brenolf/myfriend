...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dogs_address', 'city', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Address.number'
        db.alter_column(u'dogs_address', 'number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Address.state'
        db.alter_column(u'dogs_address', 'state', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Address.street'
        db.alter_column(u'dogs_address', 'street', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Address.postal_code'
        db.alter_column(u'dogs_address', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))

        # Changing field 'Address.neighbourhood'
        db.alter_column(u'dogs_address', 'neighbourhood', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Address.city'
        db.alter_column(u'dogs_address', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Address.number'
        db.alter_column(u'dogs_address', 'number', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Address.state'
        db.alter_column(u'dogs_address', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'Address.street'
        db.alter_column(u'dogs_address', 'street', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Address.postal_code'
        db.alter_column(u'dogs_address', 'postal_code', self.gf('django.db.models.fields.CharField')(default='', max_length=9))

        # Changing field 'Address.neighbourhood'
        db.alter_column(u'dogs_address', 'neighbourhood', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'dogs.address': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'neighbourhood': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True'}),
