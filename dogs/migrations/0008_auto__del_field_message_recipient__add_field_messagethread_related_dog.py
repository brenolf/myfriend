...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'dogs_message', 'recipient_id')

        # Adding field 'MessageThread.related_dog'
        db.add_column(u'dogs_messagethread', 'related_dog',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_dog', null=True, to=orm['dogs.Dog']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.recipient'
        db.add_column(u'dogs_message', 'recipient',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='recipient', to=orm['dogs.Person']),
                      keep_default=False)

        # Deleting field 'MessageThread.related_dog'
        db.delete_column(u'dogs_messagethread', 'related_dog_id')
