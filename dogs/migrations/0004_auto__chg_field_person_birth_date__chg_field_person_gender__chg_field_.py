...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dogs_person', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Person.gender'
        db.alter_column(u'dogs_person', 'gender', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Person.address'
        db.alter_column(u'dogs_person', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dogs.Address'], null=True))

    def backwards(self, orm):

        # Changing field 'Person.birth_date'
        db.alter_column(u'dogs_person', 'birth_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 12, 0, 0)))

        # Changing field 'Person.gender'
        db.alter_column(u'dogs_person', 'gender', self.gf('django.db.models.fields.CharField')(default='Male', max_length=2))

        # Changing field 'Person.address'
        db.alter_column(u'dogs_person', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['dogs.Address']))
