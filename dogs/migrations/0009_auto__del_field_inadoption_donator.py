...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InAdoption.donator'
        db.delete_column(u'dogs_inadoption', 'donator_id')


    def backwards(self, orm):
        # Adding field 'InAdoption.donator'
        db.add_column(u'dogs_inadoption', 'donator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='donator', to=orm['dogs.Person']),
                      keep_default=False)
